...
//error_reporting(E_ALL ^ E_DEPRECATED);
	...
	$result =  $link->query("SELECT * FROM `sensorLog` ORDER BY `tarih` DESC LIMIT 10",PDO::FETCH_ASSOC);
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="adminSensorGoster.php"><i class="fa fa-qrcode fa-3x"></i> Sensör Bilgileri</a>
                </li>
                <li  >
