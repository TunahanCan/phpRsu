...
$result =  $link->query("SELECT * FROM `RsuCrash` ",PDO::FETCH_ASSOC);
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a  class="active-menu"  href="adminRsuGoster.php"><i class="fa fa-desktop fa-3x"></i>Rsu Verileri</a>
                </li>
                <li>
                                        ...
                                        if($result->rowCount()) {
                                            ...
                                            foreach( $result as $row ){
                                                ...
                                                printf("<tr class='danger'><td> %s </td><td> %s </td><td> %s </td><td> %s </td></tr>",
                                                    $row["aracid"], $row["aracadi"], $row["enlem"],$row["boylam"], $row["information"]);
